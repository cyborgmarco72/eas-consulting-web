...
const alcancesAmS = [
  {
    title: "Help Desk Especializado (N1, N2, N3)",
    description:
      "Mesa de ayuda resolutiva que atiende, diagnostica y soluciona incidentes funcionales y técnicos de sus usuarios finales de SAP.",
    icon: Headphones,
  },
  {
    title: "Mantenimiento Correctivo y Evolutivo",
    description:
      "Desde la corrección rápida de bugs hasta la implementación de mejoras continuas (evolutionary maintenance) sin frenar la producción.",
    icon: Settings,
  },
  {
    title: "Monitoreo Proactivo (MDS)",
    description:
      "Vigilancia continua (24/7) del performance de su base de datos, servidores y conectividad para prevenir caídas sistémicas.",
    icon: Activity,
  },
  {
    title: "Gestión Parches y Actualizaciones",
    description:
      "Aplicación controlada de SAP Notes, Support Packages y parches de seguridad para mantener su entorno siempre vigente y blindado.",
    icon: RefreshCw,
  },
  {
    title: "Auditoría de Salud del Sistema",
    description:
      "Análisis periódico de EarlyWatch Alerts (EWA) para recomendar optimizaciones de infraestructura y código estándar (ABAP).",
    icon: ShieldCheck,
  },
  {
    title: "Alineación de Procesos de Negocio",
    description:
      "Adeación continua del ERP a nuevas regulaciones fiscales, facturación electrónica o cambios en los propios flujos operativos de la empresa.",
    icon: TrendingUp,
  },
];
...
const beneficiosAms = [
  {
    ...
    description:
      "Maximice el Uptime (tiempo de actividad) de su SAP. Prevenimos incidentes antes de que afecten la rentabilidad comercial y productiva.",
    icon: Clock,
  },
  {
    title: "Control de Costos (OPEX)",
    description:
      "Cambie gastos impredecibles de consultoría de emergencia por planes de soporte predecibles, métricos y adaptados a su demanda.",
    icon: Database,
  },
  {
    title: "Foco en el Core Business",
    description:
      "Libere a su equipo interno de TI de resolver tickets diarios, permitiéndoles concentrarse en innovación y estrategia empresarial clave.",
    icon: CheckCircle,
  },
];
...
export default function SoporteOperativoPage() {
  return (
    <main className="min-h-screen bg-white text-gray-900 font-poppins">
      ...
      <section className="relative min-h-[550px] flex items-center justify-center px-6 pt-32 pb-24 overflow-hidden">
        ...
        {/* Capa 1: Imagen de fondo representativa de un IT Operation Center / Soporte Técnico moderno */}
        <div className="absolute inset-0 z-0">
          <img 
            src="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=1200&auto=format&fit=crop"
            alt="Soporte AMS y MDS Background" 
        ...
        <div className="relative z-30 max-w-5xl mx-auto text-center text-white">
          ...
          <motion.p {...fadeUp(0.2)} className="text-lg md:text-[20px] text-white/90 max-w-3xl mx-auto mb-10 leading-relaxed font-medium">
            Garantizamos la continuidad, estabilidad y mejora permanente de sus sistemas SAP y bases de datos. Reduzca riesgos y potencie la productividad de sus usuarios a través de una mesa de ayuda experta certificada.
          </motion.p>
      ...
      <section className="px-6 py-24 max-w-7xl mx-auto">
        <motion.div {...fadeUp(0)} className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-[#103268] font-exo uppercase tracking-tight">
            Nuestros Servicios de Soporte y Monitoreo
          </h2>
          <p className="mt-4 text-gray-500 max-w-2xl mx-auto text-sm leading-relaxed font-poppins">
            Entregamos soluciones concretas basadas en Acuerdos de Nivel de Servicio (SLA) estrictos, operando de la mano con las metas de su organización.
          </p>
        </motion.div>

        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {alcancesAmS.map((item, i) => {
      ...
      <section className="px-6 py-24 bg-slate-50/60 border-t border-b border-slate-100">
        <div className="max-w-7xl mx-auto">
          <motion.div {...fadeUp(0)} className="text-center mb-16">
            ...
            <p className="mt-4 text-gray-500 max-w-2xl mx-auto text-sm leading-relaxed font-poppins">
              Asegure su inversión en tecnología con un modelo operativo diseñado para eliminar la fricción técnica y prevenir fallas críticas de negocio.
            </p>
          </motion.div>

          <div className="grid md:grid-cols-3 gap-8">
            {beneficiosAms.map((item, i) => {
              const IconComponent = item.icon;
              return (
